...
namespace Assets.HeroEditor4D.Common.EditorScripts
{
    ...
    public class CharacterEditor : CharacterEditorBase
    {
        ...
        private ItemParams CreateFakeItemParams(Item item, SpriteGroupEntry sprite, string replaceable = null, string replacement = null)
        {
            ...
            return new ItemParams { Id = item.Id, SpriteId = spriteId, Meta = sprite == null ? null : JsonConvert.SerializeObject(sprite.Tags) };
        }
        ...
        */
        ...
        public void Save()
        {
            ...
            if (!PrefabFolder.Contains("/Assets/")) throw new Exception("Unity can save prefabs only inside Assets folder!");
